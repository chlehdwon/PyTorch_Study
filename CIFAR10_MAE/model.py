...
class MaskedAutoencoder(nn.Module):
    ...
    @freeze_mask.setter
    def freeze_mask(self, val):
        self._freeze_mask = val

    @staticmethod
    def pos_encoding(n, d, k=10000):
...
class MAE(L.LightningModule):
    ...
    def masked_mse_loss(self, img, recon):
